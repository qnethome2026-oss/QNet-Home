...
## Where we are (updated 2026-08-06)
...
- **Still human/device-gated:** D-phases of the voice plan (retire her IQ9 stack with Muni; second Ventuno bring-up; voice on the kitchen board + G3 room checklist + T6.4 wake soak), T4.3 live fall takes + threshold tuning, dashboard visual checklists, T7.2 rehearsals, submission form.
