...
- **Still human-gated:** T0.2/T3.1 (speech — colleague), T4.3 live fall takes + threshold tuning (camera is armed and waiting), T6.4 wake soak (audio — speech-gated; typed wake works), dashboard visual checklists, T7.2 rehearsals, PRs + submission form.
