...
| [`ventuno-imsdk/`](ventuno-imsdk/) | 🧪 EXPERIMENTAL, flagged OFF: fall detection with an IM SDK GStreamer front half (`bring_up.sh --imsdk`), incl. the full converter investigation + the road to the all-GStreamer pipeline | ✅ clip-verified 2026-08-07 · live camera pending |
